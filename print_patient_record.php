...
$errPL=" Patient Report Generation - All * Field are Compulsory !!";
		...
		<div class="imageupload panel panel-primary">
			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="margin-bottom:10px;margin-top:10px;text-align:centre;padding-bottom:10px">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel-primary" style="margin-bottom:5px;margin-top:5px;text-align:centre;padding-top:5px;background-color:#CCCCFF">
						...
						<h4>Enter Patient Card ID N<u>o</u> OR Any Part Of Patient Name To Search </h4>
						<hr/>
						<form role="form"  name="search_form"  id="form2" class="form-vertical" action="search_result.php" enctype="multipart/form-data" method="POST">
							...
							<input type="hidden" name="sec" value="<?php echo $sec ?>" ></input>
							    <div class="form-group">
									<label for="txtsearch" class="control-label col-xs-3">Enter Card ID N<u>o</u> / Any Part Of Patient Name : <span style="color:red">(*)</span></label>
									<div class="col-xs-6">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel-primary" style="margin-bottom:5px;margin-top:5px;text-align:centre;padding-top:5px;background-color:#CCCCFF">
						...
						<hr/>
						<form role="form"  name="form3"  id="form3" class="form-vertical" action="search_result.php" enctype="multipart/form-data" method="POST">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel-primary" style="margin-bottom:5px;margin-top:5px;text-align:centre;padding-top:5px;background-color:#CCCCFF">
						...
						<hr/>
						<form role="form"  name="form4"  id="form4" class="form-vertical" action="search_result.php" enctype="multipart/form-data" method="POST">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel-primary" style="margin-bottom:5px;margin-top:5px;text-align:centre;padding-top:5px;background-color:#CCCCFF">
						...
						<hr/>
						<form role="form"  name="form5"  id="form5" class="form-vertical" action="search_result.php" enctype="multipart/form-data" method="POST">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panel-primary" style="margin-bottom:5px;margin-top:5px;text-align:centre;padding-top:5px;background-color:#CCCCFF">
						...
						<hr/>
						<form role="form"  name="form6"  id="form6" class="form-vertical" action="search_result.php" enctype="multipart/form-data" method="POST">
