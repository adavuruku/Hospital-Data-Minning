			...
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="margin-bottom:10px;margin-top:10px;text-align:centre;padding-top:10px">
				...
				$my_file_two =$stmt_ina= $stmt_inaa="";
					...
					if($_SESSION['clearance_section'] =="Library"){
						...
						$stmt_ina->execute(array("2"));
						$stmt_inaa->execute(array("2"));
					}
					//store
					if($_SESSION['clearance_section'] =="Bursary"){
					...
					if($_SESSION['clearance_section'] =="Faculty"){
						...
						$stmt_ina->execute(array($_SESSION['staff_faculty'],"2"));
						$stmt_inaa->execute(array($_SESSION['staff_faculty'],"2"));
					}
					if($_SESSION['clearance_section'] =="Department"){
						...
						$stmt_ina->execute(array($_SESSION['staff_dept'],"2"));
						$stmt_inaa->execute(array($_SESSION['staff_dept'],"2"));
					}
					...
					if($affected_rows_in >= 1) 
					{
										...
										<div style="width:100%;" class="modal-content">
											...
											<tbody>
												<tr>
													...
													<td><br/><br/><br/><h4 style="text-align:center"><a href=all_rejected_app.php?m_='.$_SESSION['page_authy'].'&appid='.$row_two['appid'].'&l_w='.$sec.'&opr='."approve".'><span class="btn btn-primary">Approve Application</span></a></h4></td>
													
													<td><br/><br/><br/><h4 style="text-align:center"><a href=all_rejected_app.php?m_='.$_SESSION['page_authy'].'&appid='.$row_two['appid'].'&l_w='.$sec.'&opr='."disapprove".'><span class="btn btn-warning">Disapprove Application</span></a></h4></td>
													
													<td><br/><br/><br/><h4 style="text-align:center"><a href=all_rejected_app.php?m_='.$_SESSION['page_authy'].'&appid='.$row_two['appid'].'&l_w='.$sec.'&opr='."reject".' ><span class="btn btn-danger">Reject Application</span></a></h4></td>
												</tr>
												<tr>
						...
						<a class="text-right" style="text-decoration:none;color:black;" target="_blank" href=all_rejected_print.php?m_='.$_SESSION['page_authy'].'&l_w='.$sec.'><h4><span class="glyphicon glyphicon-print" style="cursor:pointer;text-align:center;font-weight:900;padding:5px;"></span>Print</h4></a>
						<table class="table table-condensed" style="background-color:#FFFFFF;margin-top:5px">
							...
							echo $data.'</tbody></table><a class="text-right" style="text-decoration:none;color:black;" target="_blank" href=all_rejected_print.php?m_='.$_SESSION['page_authy'].'&l_w='.$sec.'><h4><span class="glyphicon glyphicon-print" style="cursor:pointer;text-align:center;font-weight:900;padding:5px;"></span>Print</h4></a>';
					}else{
						echo '<div class="alert alert-info alert-dismissable">
								   <button type="button" class="close" data-dismiss="alert" 
									  aria-hidden="true">
									  &times;
								   </button><h3>There is no more Clearance Application Rejected by You..</h3></div>';
					}
				?>
				<!-- End list. -->
			</div>
